...
//==============================================================================
DiplomSynthAudioProcessorEditor::DiplomSynthAudioProcessorEditor (DiplomSynthAudioProcessor& p)
...
DiplomSynthAudioProcessorEditor::~DiplomSynthAudioProcessorEditor()
{
    stopTimer();
}

//==============================================================================
void DiplomSynthAudioProcessorEditor::paint (juce::Graphics& g)
{
    g.fillAll (juce::Colours::black);
}

void DiplomSynthAudioProcessorEditor::resized()
{
...
void DiplomSynthAudioProcessorEditor::timerCallback()
{
    repaint();
}
